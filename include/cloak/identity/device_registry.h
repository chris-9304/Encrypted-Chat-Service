...
#include <cloak/identity/device_link.h>
...
public:
    ...
    cloak::core::Result<void> init_as_secondary(DeviceCert cert);

    // Primary: issue a cert for a secondary device.
    cloak::core::Result<DeviceCert> issue_cert(
        const Identity&          self,
        const cloak::core::PublicKey& secondary_signing_pub,
    ...
    cloak::core::Result<void> register_peer_device(const DeviceCert& cert);
