...
cloak::core::Result<Frame> decode(std::span<const std::byte> bytes) {
    if (bytes.size() < 5) {
        return std::unexpected(cloak::core::Error::from(
            cloak::core::ErrorCode::FramingError, "Frame underflow (< 5 bytes)"));
    }
    ...
    if (len == 0) {
        return std::unexpected(cloak::core::Error::from(
            cloak::core::ErrorCode::FramingError, "Frame length is zero"));
    }
    if (len > kMaxFrameBodySize) {
        return std::unexpected(cloak::core::Error::from(
            cloak::core::ErrorCode::FramingError, "Frame too large"));
    }
    if (bytes.size() < static_cast<size_t>(4 + len)) {
        return std::unexpected(cloak::core::Error::from(
            cloak::core::ErrorCode::FramingError, "Incomplete frame"));
    }
...
cloak::core::Result<std::vector<std::byte>> encode_handshake(
    const HandshakePayload& h) {

    if (h.display_name.size() > 64) {
        return std::unexpected(cloak::core::Error::from(
            cloak::core::ErrorCode::InvalidArgument,
...
cloak::core::Result<HandshakePayload> decode_handshake(
...
cloak::core::Result<std::vector<std::byte>> encode_file_chunk(
...
cloak::core::Result<FileChunkPayload> decode_file_chunk(
    std::span<const std::byte> bytes) {
...
cloak::core::Result<std::vector<std::byte>> encode_receipt(
...
cloak::core::Result<ReceiptPayload> decode_receipt(
    std::span<const std::byte> bytes) {
...
cloak::core::Result<std::vector<std::byte>> encode_group_message(
...
cloak::core::Result<GroupMessagePayload> decode_group_message(
    std::span<const std::byte> bytes) {
...
cloak::core::Result<std::vector<std::byte>> encode_group_op(
...
cloak::core::Result<GroupOpPayload> decode_group_op(
    std::span<const std::byte> bytes) {
