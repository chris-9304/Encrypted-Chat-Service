...
cloak::core::Result<void> LoopbackDiscoveryService::start_advertising(
...
cloak::core::Result<void> LoopbackDiscoveryService::stop_advertising() {
    std::lock_guard lock(mu_);
    advertising_ = false;
    adv_.reset();
    return {};
...
cloak::core::Result<std::vector<DiscoveredPeer>>
