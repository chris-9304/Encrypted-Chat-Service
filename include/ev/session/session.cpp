...
constexpr std::string_view kInfoSk    = "EncryptiV_SessionKey_v2";
constexpr std::string_view kInfoRkCk  = "EncryptiV_DR_RK_CK_v2";
constexpr std::string_view kInfoNonce = "EncryptiV_DR_MK_NONCE_v2";
...
Session::Session(std::unique_ptr<ev::transport::Transport> t, bool is_initiator)
...
Result<void> Session::dr_init_initiator(
    const ev::crypto::SharedSecret& sk, const PublicKey& peer_dr_pub) {
...
Result<void> Session::dr_init_responder(
    ...
    peer_dr_pub_ = ev::core::PublicKey{};
    dr_ns_ = 0; dr_nr_ = 0; dr_pn_ = 0;
