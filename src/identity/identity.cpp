...
Result<void> Identity::save(const ev::core::Path& path,
...
Result<Identity> Identity::load(const ev::core::Path& path,
...
bool Identity::exists(const ev::core::Path& path) {
...
ev::core::SafetyNumber Identity::safety_number(const PublicKey& a,
                                                const PublicKey& b) {
